...
import { CONSTANT_DEFAULT_IMAGE_URL } from "../constants/default.const";
...
export const mockObjectsRelax: IDataCardSlider[] = [
    ...
    {
        id: 6,
        title: "Казахский Государственный академический театр оперы и балета имени Абая",
        location: "Алматы, Казахстан",
        rating: 5,
        reviews: 50,
        globalType: "relax",
...
export const mockObjectForObjectPage = {
    ...
    query: [
        ...
        },
        {
            key: "service",
            title: "УСЛУГИ",
            value: "Еда на вынос, Бронирование, Столики на открытом воздухе, Места для сидения, Детские стульчики для кормления, Подают алкоголь, Бар, Принимаются карты Mastercard, Принимаются карты Visa, Бесплатный Wi-Fi, Принимаются кредитные карты, Обслуживание посетителей за столиками, Подарочные карты",
        },
    ],
    queryForModal: [
